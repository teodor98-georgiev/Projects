...
public class Main {
    ...
    public static String dayOfProgrammer(int year) {
        int[] monthDays;
        LinkedHashMap<String, Integer> monthIndex = new LinkedHashMap<>();
        ...
        monthIndex.put("jan", 1);
        monthIndex.put("feb", 2);
        ...
        monthIndex.put("sep", 9);
        monthIndex.put("oct", 10);
        monthIndex.put("nov", 11);
        monthIndex.put("dec", 12);

        int eightMonthsSum = 0;
        int monthTrack = 0;
        for (Integer number : monthDays){
            if (monthTrack < 8){
                eightMonthsSum = eightMonthsSum + number;
                monthTrack++;
            }
            else {
                break;
        ...
        String dateFormat;
        dateFormat = String.valueOf(256 - eightMonthsSum) + "." +"0" + String.valueOf(monthIndex.get("sep")) +"." +
                String.valueOf(year);
        return dateFormat;
    }
}